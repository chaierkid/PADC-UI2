...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:174px;left:549px;height:auto;" onActive="modelActive" onParamsReceive="modelParamsReceive"> 
    <div component="$UI/system/components/justep/data/baasData" autoLoad="false" xid="baasData1" queryAction="queryTabquestiond" saveAction="saveTabquestiond" url="/question/question" tableName="tabquestiond" idColumn="fID" orderBy="fCreateDate:desc" confirmDelete="false" confirmRefresh="false" limit="20"><column label="fID" name="fID" type="String" xid="default34"></column>
  ...
  <column label="fRealName" name="fRealName" type="String" xid="default37"></column>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"> 
    <div class="x-panel-top" height="60"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" title="刀具管控列表"
        ...
        <div class="x-titlebar-title">刀具管控列表</div>  
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7">
   ...
   <div class="x-col x-col-67 x-col-center" xid="col12">
    <label xid="label6" style="font-weight:normal;">商场/超市/市场名称：</label></div> 
