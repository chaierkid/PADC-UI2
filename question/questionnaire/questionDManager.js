define(function(require) {
	...
	Model.prototype.button1Click = function(event){
		justep.Shell.showPage( "questionD",{operator:"new"});	
	};
	...
	Model.prototype.li1Click = function(event){
		...
		data.saveData();
		justep.Shell.showPage( "questionDShow",{operator:"query",id:fid});
	};
	
	Model.prototype.modelActive = function(event){
//		var data = this.comp("baasData1");
//		var cond =  "  tabquestiond.tabIsDelete=0 ";
//		if(this.getParent().userType=='访员'){
//			cond += " and tabquestiond.fCreator='"+this.getParent().userName+"'";
//		}
//		if(this.getParent().userType =='区域'){
//			cond += " and tabquestiond.fArea='"+this.getParent().userName+"'";
//    	} 
//		if(createDate !==null &&createDate !== '' &&createDate !==undefined){
//			cond += " and tabquestiond.fPhotoTime between  '"+createDate+" 00:00:00' and  '"+createDate+" 23:59:59'" ;
//		}
//		data.setFilter("tabquestiond", cond);
//		data.refreshData();
//		 
	...
	Model.prototype.button4Click = function(event){
		...
		if(type=='访员名称'){ 
			if(name!==null &&name!==''&& name!==undefined  ){
				cond+=" and tabquestiond.fCreator = '"+name+"' ";
			}
		}else if(type=='区域'){
			if(area!==null &&area!==''&& area!==undefined  ){
				cond+=" and tabquestiond.fArea = '"+area+"' ";
			}
		}else if(type=='调查时间'){
			if(time!==null &&time!==''&& time!==undefined  ){
				cond += " and tabquestiond.fCreateDate between  '"+time+" 00:00:00' and  '"+time+" 23:59:59'" ;
			}
		}else if(type=='问卷状态'){
			if(status!==null &&status!==''&& status!==undefined  ){
				cond += " and ( tabquestiond.fStatus2 ='"+status+"' or tabquestiond.fStatus3 ='"+status+"' or tabquestiond.fStatus ='"+status+"')  " ;
			}
		}
