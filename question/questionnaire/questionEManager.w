...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:174px;left:549px;height:auto;" onActive="modelActive" onParamsReceive="modelParamsReceive"> 
    <div component="$UI/system/components/justep/data/baasData" autoLoad="false" xid="baasData1" queryAction="queryTabquestione" saveAction="saveTabquestione" url="/question/question" tableName="tabquestione" idColumn="fID" orderBy="fCreateDate:desc" confirmDelete="false" confirmRefresh="false" limit="20"><column label="fID" name="fID" type="String" xid="default34"></column>
  <column label="fArea" name="fArea" type="String" xid="default35"></column>
  <column label="fStreet" name="fStreet" type="String" xid="default36"></column>
  <column label="fProblem" name="fProblem" type="String" xid="default37"></column>
  <column label="fPhotoTime" name="fPhotoTime" type="DateTime" xid="default38"></column>
  <column label="fPhoto" name="fPhoto" type="String" xid="default39"></column>
  <column label="fCreator" name="fCreator" type="String" xid="default40"></column>
  <column label="fCreateDate" name="fCreateDate" type="DateTime" xid="default41"></column>
  <column label="tabIsDelete" name="tabIsDelete" type="String" xid="default42"></column>
  <column label="fEditor" name="fEditor" type="String" xid="default43"></column>
  <column label="fEditeDate" name="fEditeDate" type="DateTime" xid="default44"></column>
  <column label="fContent" name="fContent" type="String" xid="default45"></column>
  <column label="fStatus" name="fStatus" type="String" xid="default46"></column>
  <column label="fStatus2" name="fStatus2" type="String" xid="default47"></column>
  <column label="fStatus3" name="fStatus3" type="String" xid="default48"></column></div>
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data4" idColumn="id">
   ...
   <data xid="default14">[{&quot;id&quot;:&quot;督导已复核&quot;,&quot;name&quot;:&quot;督导已复核&quot;},{&quot;id&quot;:&quot;督导未复核&quot;,&quot;name&quot;:&quot;督导未复核&quot;},{&quot;id&quot;:&quot;领导已审阅&quot;,&quot;name&quot;:&quot;领导已审阅&quot;},{&quot;id&quot;:&quot;领导未审阅&quot;,&quot;name&quot;:&quot;领导未审阅&quot;},{&quot;id&quot;:&quot;相关区已查看&quot;,&quot;name&quot;:&quot;相关区已查看&quot;},{&quot;id&quot;:&quot;相关区未查看&quot;,&quot;name&quot;:&quot;相关区未查看&quot;}]</data></div>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"> 
    <div class="x-panel-top" height="60"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" title="重点医院列表"
        ...
        <div class="x-titlebar-title">重点医院列表</div>  
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7">
   ...
   <div class="x-col x-col-33 x-col-center" xid="col12">
    <label xid="label6" style="font-weight:normal;"><![CDATA[医院名称：]]></label></div> 
  ...
  <div class="x-row x-row-center" component="$UI/system/components/justep/row/row" xid="row4">
   <div class="x-col x-col-20 x-col-center" xid="col3">
    <label xid="label2" style="font-weight:normal;"><![CDATA[状态：]]></label></div> 
  ...
  <div class="x-col" xid="col4" style="font-weight:bold;font-size:small;"><span component="$UI/system/components/justep/output/output" data="taskData" bind-ref='ref("fStatus")' xid="output4"></span></div>
  <div class="x-col" xid="col5" style="font-weight:bold;font-size:small;"><span component="$UI/system/components/justep/output/output" data="taskData" bind-ref='ref("fStatus3")' xid="output5"></span></div></div></li> 
              </ul> 
            </div>  
