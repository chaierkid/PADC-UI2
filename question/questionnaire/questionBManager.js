define(function(require) {
	...
	Model.prototype.li1Click = function(event){
		...
		data.saveData();
		justep.Shell.showPage( "questionBShow",{operator:"query",id:fid});
	};
...
//		}
//		if(this.getParent().userType =='区域'){
//			cond += " and tabquestionb.fArea='"+this.getParent().userName+"'";
//    	} 
//		if(createDate !==null &&createDate !== '' &&createDate !==undefined){
//			cond += " and tabquestionb.fPhotoTime between  '"+createDate+" 00:00:00' and  '"+createDate+" 23:59:59'" ;
//		}
	...
	Model.prototype.button4Click = function(event){
		...
		if(type=='访员名称'){ 
			if(name!==null &&name!==''&& name!==undefined  ){
				cond+=" and tabquestionb.fCreator = '"+name+"' ";
			}
		}else if(type=='区域'){
			if(area!==null &&area!==''&& area!==undefined  ){
				cond+=" and tabquestionb.fArea = '"+area+"' ";
			}
		}else if(type=='调查时间'){
			if(time!==null &&time!==''&& time!==undefined  ){
				cond += " and tabquestionb.fCreateDate between  '"+time+" 00:00:00' and  '"+time+" 23:59:59'" ;
			}
		}else if(type=='问卷状态'){
			if(status!==null &&status!==''&& status!==undefined  ){
				cond += " and ( tabquestionb.fStatus2 ='"+status+"' or tabquestionb.fStatus3 ='"+status+"' or tabquestionb.fStatus ='"+status+"')  " ;
			}
		}
