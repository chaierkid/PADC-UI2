...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:307px;left:609px;"
    ...
    <div component="$UI/system/components/justep/data/baasData" xid="tabquestion"
      directDelete="false" autoLoad="false" idColumn="fID" queryAction="queryTabquestiona"
      tableName="tabquestiona" url="/question/question" saveAction="saveTabquestiona"
      confirmRefresh="false" limit="10" confirmDelete="false"> 
      <column isCalculate="true" label="选择" name="calcCheckBox" type="Boolean"
        xid="calcCheckBox"/>  
      <column label="fID" name="fID" type="String" xid="default25"></column>
  <column label="fArea" name="fArea" type="String" xid="default26"></column>
  <column label="fStreet" name="fStreet" type="String" xid="default27"></column>
  <column label="fProblem" name="fProblem" type="String" xid="default28"></column>
  <column label="fPhotoTime" name="fPhotoTime" type="DateTime" xid="default29"></column>
  <column label="fPhoto" name="fPhoto" type="String" xid="default30"></column>
  <column label="fCreator" name="fCreator" type="String" xid="default31"></column>
  <column label="fCreateDate" name="fCreateDate" type="DateTime" xid="default32"></column>
  <column label="tabIsDelete" name="tabIsDelete" type="String" xid="default33"></column>
  <column label="fEditor" name="fEditor" type="String" xid="default34"></column>
  <column label="fEditeDate" name="fEditeDate" type="DateTime" xid="default35"></column>
  <column label="fContent" name="fContent" type="String" xid="default36"></column>
  <column label="fStatus" name="fStatus" type="String" xid="default37"></column>
  <column label="fStatus2" name="fStatus2" type="String" xid="default38"></column>
  <column label="fStatus3" name="fStatus3" type="String" xid="default39"></column></div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1" height="60"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        xid="titleBar1" title="街面秩序" style="height:100%;font-size:x-large;"> 
   ...
   <div class="x-col" xid="col5">
    <label class="x-label" xid="label13" style="font-weight:bold;"><![CDATA[Q3.街面秩序存在问题（多选）：]]></label></div> 
   ...
   <div class="x-col x-col-center" xid="col6"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit5">
   <label class="x-label" xid="label7" style="font-size:medium;"><![CDATA[具体描述：]]></label>
   <div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output2" bind-ref='$model.tabquestion.ref("fContent")'></div></div></div>
