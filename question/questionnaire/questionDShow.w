...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <column label="fRealName" name="fRealName" type="String" xid="default21"></column>
  <column label="fPhotoTime" name="fPhotoTime" type="DateTime" xid="default22"></column>
  <column label="fPhoto" name="fPhoto" type="String" xid="default23"></column>
  <column label="fCreator" name="fCreator" type="String" xid="default24"></column>
  <column label="fCreateDate" name="fCreateDate" type="DateTime" xid="default25"></column>
  <column label="tabIsDelete" name="tabIsDelete" type="String" xid="default26"></column>
  <column label="fEditor" name="fEditor" type="String" xid="default27"></column>
  <column label="fEditeDate" name="fEditeDate" type="DateTime" xid="default28"></column>
  <column label="fContent" name="fContent" type="String" xid="default29"></column>
  <column label="fStatus" name="fStatus" type="String" xid="default30"></column>
  <column label="fStatus2" name="fStatus2" type="String" xid="default31"></column>
  <column label="fStatus3" name="fStatus3" type="String" xid="default32"></column></div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1" height="60"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        xid="titleBar1" title="刀具管控" style="height:100%;font-size:x-large;"> 
   ...
   <div class="x-col" xid="col2">
    <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label40" xid="labelEdit2">
   <label class="x-label" xid="label2" style="font-weight:bold;"><![CDATA[Q2.商场/超市/市场名称：]]></label>
   ...
   <div class="x-col  x-col-center" xid="col7">
    <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label55" xid="labelEdit5">
     <label class="x-label" xid="label6" style="font-weight:bold;"><![CDATA[Q3.是否必须实名购买？]]></label>
   ...
   <div class="x-col" xid="col5">
    <label class="x-label" xid="label13" style="font-weight:bold;">Q4.问题具体描述：</label></div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row15">
   <div class="x-col x-col-center" xid="col4">
    <div component="$UI/system/components/justep/output/output" class="x-output" xid="output15" bind-ref='$model.tabquestion.ref("fContent")'></div></div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row3"> 
        <div class="x-col" xid="col9"> 
          <label xid="label5"><![CDATA[Q5.证据照片（2张以上，体现地理标志和问题事实）：]]></label>
        </div> 
      </div>  
  ...
  <div class="x-row x-row-center" component="$UI/system/components/justep/row/row" xid="row8">
   ...
   <div class="x-col" xid="col6" style="font-weight:bold;">
