define(function(require){
	...
	Model.prototype.modelParamsReceive = function(event){
		...
		data.setFilter("tabquestiond", "tabquestiond.fID='"+parentID+"'  "
				+ " and tabquestiond.tabIsDelete=0 ");
		data.refreshData();
	...
	Model.prototype.button31Click = function(event){
		justep.Shell.showPage("questionDManager");
	};
	...
	Model.prototype.button3Click = function(event){
		justep.Shell.showPage( "questionD",{operator:"edit",id:parentID});
	};
