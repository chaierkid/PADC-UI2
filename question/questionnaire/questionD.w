...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:307px;left:609px;"
    ...
    <div component="$UI/system/components/justep/data/baasData" xid="tabquestion"
      directDelete="false" autoLoad="false" idColumn="fID" queryAction="queryTabquestiond"
      tableName="tabquestiond" url="/question/question" saveAction="saveTabquestiond"
  ...
  <column label="fID" name="fID" type="String" xid="default53"></column>
  <column label="fArea" name="fArea" type="String" xid="default54"></column>
  <column label="fStreet" name="fStreet" type="String" xid="default55"></column>
  <column label="fRealName" name="fRealName" type="String" xid="default56"></column>
  <column label="fPhotoTime" name="fPhotoTime" type="DateTime" xid="default57"></column>
  <column label="fPhoto" name="fPhoto" type="String" xid="default58"></column>
  <column label="fCreator" name="fCreator" type="String" xid="default59"></column>
  <column label="fCreateDate" name="fCreateDate" type="DateTime" xid="default60"></column>
  <column label="tabIsDelete" name="tabIsDelete" type="String" xid="default61"></column>
  <column label="fEditor" name="fEditor" type="String" xid="default62"></column>
  <column label="fEditeDate" name="fEditeDate" type="DateTime" xid="default63"></column>
  <column label="fContent" name="fContent" type="String" xid="default64"></column>
  <rule xid="rule1">
   ...
   <col name="fRealName" xid="ruleCol3">
   ...
   <col name="fPhotoTime" xid="ruleCol4">
    <required xid="required4">
     <expr xid="default22"></expr>
     <message xid="default23"></message></required> </col> 
   <col name="fPhoto" xid="ruleCol5">
    <required xid="required5">
     <expr xid="default24"></expr>
     <message xid="default25"></message></required> </col> </rule></div>
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data4" idColumn="id">
   ...
   <data xid="default21">[{&quot;id&quot;:&quot;1&quot;,&quot;name&quot;:&quot;是&quot;},{&quot;id&quot;:&quot;2&quot;,&quot;name&quot;:&quot;否&quot;},{&quot;id&quot;:&quot;3&quot;,&quot;name&quot;:&quot;未发现刀具售卖&quot;}]</data></div></div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    xid="panel1"> 
    <div class="x-panel-top" xid="top1" height="60"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        xid="titleBar1" title="刀具管控" style="font-size:medium;height:100%;"> 
        ...
        <div class="x-titlebar-title" xid="title1">刀具管控</div>  
  ...
  <div class="x-col" xid="col20"><select component="$UI/system/components/justep/select/select" class="form-control" xid="select2" style="height:35px;" bind-options="data1" bind-optionsValue="name" bind-ref='$model.tabquestion.ref("fArea")'></select></div></div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row9">
   <div class="x-col x-col-center" xid="col19">
    <label xid="label10"><![CDATA[Q2.商场/超市/市场名称：]]></label></div> 
  <div class="x-col" xid="col21"><input component="$UI/system/components/justep/input/input" class="form-control" xid="input3" style="height:35px;" bind-ref='$model.tabquestion.ref("fStreet")'></input></div></div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row6">
   <div class="x-col" xid="col1">
    <label xid="label1"><![CDATA[Q3.是否必须实名购买？]]></label></div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
   <div class="x-col x-col-center" xid="col2">
    <span component="$UI/system/components/justep/select/radioGroup" class="x-radio-group" xid="radioGroup3" bind-itemset="data4" bind-itemsetValue='ref("name")' bind-itemsetLabel='ref("name")' bind-ref='$model.tabquestion.ref("fRealName")'></span></div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row10">
   <div class="x-col x-col-33 x-col-center" xid="col23">
    <label xid="label3"><![CDATA[Q4.问题具体描述:]]></label></div> 
   ...
   <div class="x-col" xid="col9">
    <label xid="label5"><![CDATA[Q5.证据照片（2张以上，体现地理标志和问题事实）：]]></label></div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
