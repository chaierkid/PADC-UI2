...
var __parent0=require('$model/UI2/question/newprotal/channel/menu14Pic2'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='czQFFBb';
	this._flag_='ea5ab4bb9db0edd5cc31e46c89977432';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","label":"id","name":"id","relation":"id","type":"String"},"title":{"define":"title","label":"title","name":"title","relation":"title","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","initData":"[{\"id\":\"1\",\"title\":\"背部独特按键设计 LG四核智能G2售3299\"},{\"id\":\"2\",\"title\":\"1.9GHz四核骁龙芯 港版三星I9505售3099\"},{\"id\":\"3\",\"title\":\"6.3英寸巨屏诱惑 三星i9200行货仅2350\"},{\"id\":\"4\",\"title\":\"微软称Mac版Office今年年底前将推出新版\"}]","limit":20,"xid":"data"});
}}); 
return __result;});
