...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  ...
  <filter name="filter0" xid="filter1"><![CDATA[tabImageAPP.fType='mainQuestion']]></filter></div>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card"> 
    <div class="x-panel-top"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" title="主要问题"> 
        ...
        <div class="x-titlebar-title">主要问题</div>  
