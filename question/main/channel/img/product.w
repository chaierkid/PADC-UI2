...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  ...
  <column label="fID" name="fID" type="String" xid="default4"></column></div>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card"> 
    <div class="x-panel-top"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" title="暗访安排"> 
        ...
        <div class="x-titlebar-title">暗访安排</div>  
          ...
          <li class="col-xs-4"> 
            <div class="thumbnail" style="height:70px;"> 
              <div component="$UI/system/components/justep/attachment/attachmentSimple"
                actionUrl="/baas/justep/attachment/simpleFileStore" xid="attachmentSimple1" bind-ref='$model.image.ref("fAttachment")' style="height:100%;width:100%;"> 
