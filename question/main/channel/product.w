...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="left:18px;top:83px;height:244px;"><div component="$UI/system/components/justep/data/baasData" autoLoad="false" xid="image" queryAction="queryTabImageAPP" saveAction="saveTabImageAPP" url="/imageAPP/imageAPP" tableName="tabImageAPP" idColumn="fID" confirmDelete="false" confirmRefresh="false" orderBy="fCreateDate:desc"><column label="fCreateDate" name="fCreateDate" type="DateTime" xid="default1"></column>
  ...
  <filter name="filter0" xid="filter1"><![CDATA[tabImageAPP.fType='arrange']]></filter></div>
