...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div xid="div2" style="width:auto;float:right;"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="确定" xid="button2" onClick='{"operation":"window.close"}'>
   <i xid="i2"></i>
