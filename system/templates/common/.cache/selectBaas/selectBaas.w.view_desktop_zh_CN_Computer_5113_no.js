...
var __parent0=require('$model/UI2/system/templates/common/selectBaas'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cEJbAJ3';
	this._flag_='2481768572da04759437217cd26e5faf';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":false,"confirmRefresh":false,"defCols":{"action":{"define":"action","label":"Action","name":"action","relation":"action","type":"String"},"checked":{"define":"checked","label":"选择","name":"checked","relation":"checked","type":"Boolean"},"db":{"define":"db","label":"数据库","name":"db","relation":"db","type":"String"},"path":{"define":"path","label":"BAAS服务","name":"path","relation":"path","type":"String"},"table":{"define":"table","label":"表","name":"table","relation":"table","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"dataServiceCustomRefresh","onValueChanged":"dataServiceValueChanged"},"idColumn":"path","limit":-1,"xid":"dataService"});
