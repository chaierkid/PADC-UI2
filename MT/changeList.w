...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:389px;left:514px;height:auto;"> 
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data1" idColumn="a"><column name="a" type="String" xid="xid1"></column>
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="更改单查询"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">更改单查询</div>  
  ...
  <div class="x-col x-col-10" xid="col8"></div><div class="x-col" xid="col1"><input component="$UI/system/components/justep/input/input" class="form-control" xid="input1"></input></div><div class="x-col x-col-20 x-col-center" xid="col3" style="text-align:center;"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-icon-left" label="查询" xid="button1" icon="icon-android-search">
   <i xid="i1" class="icon-android-search"></i>
   <span xid="span1">查询</span></a></div></div></div></div>
   <div class="x-panel-content" xid="content2"><div class="x-list x-inner-scroll" component="$UI/system/components/justep/list/list" data="data1" limit="20" xid="list1" autoLoad="true">
       ...
       <li class="list-group-item" bind-click="li1Click" xid="li1">
        <div class="x-row x-row-center" component="$UI/system/components/justep/row/row" xid="row4">
         <div class="x-col x-col-33 x-col-center" style="vertical-align:middle;text-align:left;" xid="col5">
          <label xid="label1" style="font-weight:normal;"><![CDATA[更改单号：]]></label></div> 
         <div class="x-col x-col-center" xid="col4">
          <span component="$UI/system/components/justep/output/output" data="taskData" bind-ref='ref("a")' xid="output1" style="font-weight:bold;"></span></div> 
  </div> 
        <div class="x-row x-row-center" component="$UI/system/components/justep/row/row" xid="row3">
         <div class="x-col x-col-33 x-col-center" xid="col12">
          <label xid="label6" style="font-weight:normal;"><![CDATA[图文号：]]></label></div> 
        ...
        <div class="x-row x-row-center" component="$UI/system/components/justep/row/row" xid="row2">
         <div class="x-col x-col-33 x-col-center" style="vertical-align:middle;text-align:left;" xid="col7">
          <label xid="label3" style="font-weight:normal;"><![CDATA[批次：]]></label></div> 
        ...
        <div class="x-row x-row-center" component="$UI/system/components/justep/row/row" xid="row2">
         <div class="x-col x-col-33 x-col-center" xid="col10">
          <label xid="label8" style="font-weight:normal;"><![CDATA[架次：]]></label></div> 
         <div class="x-col" xid="col11" style="font-weight:bold;">
          <span component="$UI/system/components/justep/output/output" data="taskData" bind-ref='ref("d")' xid="output6"></span></div> </div> </li> </ul> </div> 
