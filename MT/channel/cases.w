...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:mobile">  
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data1" idColumn="a">
   <column name="a" type="String" xid="column1"></column>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1">
    <div component="$UI/system/components/justep/titleBar/titleBar" title="检验执行管理" class="x-titlebar" xid="titleBar1">
     ...
     <div class="x-titlebar-title" xid="title1">检验执行管理</div>
     <div class="x-titlebar-right reverse" xid="right1">
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" label="新建检验执行信息" xid="button2" icon="icon-android-add">
       <i xid="i4" class="icon-android-add"></i>
       <span xid="span5">新建检验执行信息</span></a> </div> </div> </div> 
