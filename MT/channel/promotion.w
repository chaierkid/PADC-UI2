...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1">
    <div component="$UI/system/components/justep/titleBar/titleBar" title="生产执行管理" class="x-titlebar" xid="titleBar1">
     ...
     <div class="x-titlebar-title" xid="title1">生产执行管理</div>
     <div class="x-titlebar-right reverse" xid="right1">
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" label="在制品管理" xid="button2" icon="icon-hammer">
       <i xid="i4" class="icon-hammer"></i>
       <span xid="span5">在制品管理</span></a> </div> </div> </div> 
